                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('shop_address') is-invalid @enderror"
                                        id="shop_address" name="shop_address" value="{{ old('shop_address', $customer->shop_address) }}">
                                    @error('shop_address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('customer_number') is-invalid @enderror"
                                        ...
                                        value="{{ old('customer_number', $customer->customer_number) }}" maxlength="10">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        name="city" value="{{ old('city', $customer->city) }}" min="0">
                                    @error('city')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    @if ($customer->customer_image)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $customer->customer_image) }}"
                                                alt="{{ $customer->customer_name }}" class="img-thumbnail"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    @if ($customer->shop_image)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $customer->shop_image) }}"
                                                alt="{{ $customer->customer_name }}" class="img-thumbnail"
                                                style="max-width: 200px;">
                                        </div>
                                    @endif
