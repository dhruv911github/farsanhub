    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                <div class="btn-group">
                    <a class="secondary edit-technician-btn me-2" href="{{ route('admin.order.edit', $order->id) }}"><i class="fa fa-edit"></i></a>
                    <a class="primary order-delete-btn" data-bs-toggle="modal" data-bs-target="#order-delete" data-order-id="{{ $order->id }}">
